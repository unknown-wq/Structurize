...
import com.ldtteam.structurize.compat.common.config.Configurations;
import com.ldtteam.structurize.compat.common.language.LanguageHandler;
import com.ldtteam.structurize.compat.common.network.NetworkContext;
...
public class Structurize implements ModInitializer
{
    ...
    public void onInitialize()
    {
        ...
        config = new Configurations<ClientConfiguration, ServerConfiguration, AbstractConfiguration>(Constants.MOD_ID,
