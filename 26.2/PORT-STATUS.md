...
| `com.ldtteam.blockui` | 15 | 64 | jar подключён; 13 файлов GUI ещё запаркованы до фазы 4 (C9) |
...
| 4 | Агент C — GUI | следующая: снять `exclude`, вернуть тела `GuiStubs`, портировать 13 файлов и 14 XML |
