...
| 3 | Интеграция: переезд на настоящую `com.ldtteam.common` из BlockUI, расшивка BER, `runServer` | следующая |
| 4 | Агент C — GUI | **разблокирована**: порт BlockUI приехал, jar собран, покрывает все 20 символов |
